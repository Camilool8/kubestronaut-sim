...
| `ui/src/styles/layout.test.ts` | holds the load-bearing layout declarations, including the `.desktop-canvas` rules that stop noVNC's `ResizeObserver` feeding back |
